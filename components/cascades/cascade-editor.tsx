...
const initialDeps: Dependency[] = [
  { id: "1", name: "react-core", address: "GDLX...2KMN", percentage: 2 },
  { id: "2", name: "tailwind-css", address: "GFPX...7YHN", percentage: 2 },
  { id: "3", name: "next-framework", address: "GHBX...3QRS", percentage: 2 },
]
...
export function CascadeEditor() {
  ...
  const updateDep = (id: string, field: keyof Dependency, value: string | number) => {
            ...
            <div>
              ...
              <p
                className={cn(
                  ...
                  totalPct > 50 ? "text-destructive" : "text-primary"
                )}
              >
                {totalPct.toFixed(1)}%
              </p>
